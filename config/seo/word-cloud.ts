...
const wordCloudSEO: SEOPageContent = {
    id: 'word-cloud',
    
    intro: {
        what: '词云图生成工具是一款在线图片处理服务，帮助用户快速完成图片编辑任务。',
        problem: '解决用户对词云图生成的需求，提供便捷的在线处理方案。',
        capability: '支持词云图生成处理、本地运行保证数据安全、一键操作简单易用。',
