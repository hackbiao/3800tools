...
const gifSplitterSEO: SEOPageContent = {
    id: 'gif-splitter',
    
    intro: {
        what: 'GIF分解工具是一款在线图片处理服务，帮助用户快速完成图片编辑任务。',
        problem: '解决用户对GIF分解的需求，提供便捷的在线处理方案。',
        capability: '支持GIF分解处理、本地运行保证数据安全、一键操作简单易用。',
