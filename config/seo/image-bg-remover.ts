...
const imageBgRemoverSEO: SEOPageContent = {
    id: 'image-bg-remover',
    
    intro: {
        what: '图片去底色工具是一款在线图片处理服务，帮助用户快速完成图片编辑任务。',
        problem: '解决用户对图片去底色的需求，提供便捷的在线处理方案。',
        capability: '支持图片去底色处理、本地运行保证数据安全、一键操作简单易用。',
...
export default imageBgRemoverSEO;
